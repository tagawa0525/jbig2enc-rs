...
現状のRustプロジェクトは `src/main.rs`（Hello, world!）のみ。leptonica-rsの API互換性調査（[jbig2enc-api-compatibility.md](https://github.com/tagawa0525/leptonica-rs/blob/main/docs/porting/jbig2enc-api-compatibility.md)）により、以前HIGHリスクだった2つのギャップ（morph_sequence の `r`/`x` 演算子、`rop_region_inplace`）は解消済み。
...
| 用途                   | パス                                                                                                                                                       |
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| C++ 公開API            | [jbig2enc/src/jbig2enc.h](https://github.com/agl/jbig2enc/blob/master/src/jbig2enc.h)                                                                      |
| C++ エンコーダ本体     | [jbig2enc/src/jbig2enc.cc](https://github.com/agl/jbig2enc/blob/master/src/jbig2enc.cc)                                                                    |
| C++ 算術符号化         | [jbig2enc/src/jbig2arith.cc](https://github.com/agl/jbig2enc/blob/master/src/jbig2arith.cc)                                                                |
| C++ シンボル符号化     | [jbig2enc/src/jbig2sym.cc](https://github.com/agl/jbig2enc/blob/master/src/jbig2sym.cc)                                                                    |
| C++ シンボル比較       | [jbig2enc/src/jbig2comparator.cc](https://github.com/agl/jbig2enc/blob/master/src/jbig2comparator.cc)                                                      |
| C++ データ構造         | [jbig2enc/src/jbig2structs.h](https://github.com/agl/jbig2enc/blob/master/src/jbig2structs.h)                                                              |
| C++ セグメントヘッダ   | [jbig2enc/src/jbig2segments.h](https://github.com/agl/jbig2enc/blob/master/src/jbig2segments.h)                                                            |
| C++ CLIツール          | [jbig2enc/src/jbig2.cc](https://github.com/agl/jbig2enc/blob/master/src/jbig2.cc)                                                                          |
| JBIG2仕様書            | [jbig2enc/doc/fcd14492.pdf](https://github.com/agl/jbig2enc/blob/master/doc/fcd14492.pdf)                                                                  |
| API互換性調査          | [leptonica-rs/docs/porting/jbig2enc-api-compatibility.md](https://github.com/tagawa0525/leptonica-rs/blob/main/docs/porting/jbig2enc-api-compatibility.md) |
| leptonica-rs JbClasser | [leptonica-rs/src/recog/jbclass/types.rs](https://github.com/tagawa0525/leptonica-rs/blob/main/src/recog/jbclass/types.rs) (`TEMPLATE_BORDER = 4`)         |
| leptonica-rs ROP       | [leptonica-rs/src/core/pix/rop.rs](https://github.com/tagawa0525/leptonica-rs/blob/main/src/core/pix/rop.rs) (`rop_region_inplace`)                        |
| leptonica-rs morph     | [leptonica-rs/src/morph/sequence.rs](https://github.com/tagawa0525/leptonica-rs/blob/main/src/morph/sequence.rs) (`RankReduce`, `BinaryExpand`)            |
